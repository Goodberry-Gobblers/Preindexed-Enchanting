...
The flagship feature of the mod, enchantment slots. As defined by the , any enchantments can be applied to these items (even mutally exclusive ones) as long as the sum of their levels is equal to or less than the item's max enchantment slots.
